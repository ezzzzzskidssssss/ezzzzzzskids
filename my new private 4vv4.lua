...
local AutoFarm = window:AddTab("Farm STRENGTH")
AutoFarm:Show()
...
local PROTEIN_EGG_INTERVAL = 10 * 60 -- 10 min
local REPS_PER_CYCLE = 150
local REP_DELAY = 0.02
...
AutoFarm:AddSwitch("Anti AFK", function(state)
    if state then
        ...
        uselesslabelone.Text = "Anti Afk BY BSW_Dark👻"
        ...
        uselesslabelfour.BackgroundTransparency = 0
...
Credits:AddLabel("Made by DARKNESS👻")
Credits:AddLabel("Made by DARKNESS👻")
